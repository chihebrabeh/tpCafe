    ...
    public CommandLineRunner demo() {
        return (args) -> {
         ...
         Equipe Equipe_jour= new Equipe("Equipe_jour",1);
           ...
           cafeService.save(glace);  cafeService.save(lait);
            ...
            demandeService.save(DemandeSourour);demandeService.save(Demande3Sourour);
            demandeService.save(Demande2Sourour);demandeService.save(DemandeAllongeSourour);
            ...
            ConsommationSemaine Cs1=new ConsommationSemaine("samaine 1 octobore",5,chefProjet);
